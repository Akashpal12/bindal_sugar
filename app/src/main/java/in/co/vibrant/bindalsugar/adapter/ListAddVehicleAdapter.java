...
public class ListAddVehicleAdapter extends RecyclerView.Adapter<ListAddVehicleAdapter.MyHolder> {

    private Context context;
    List <GrowerModel> arrayList;


    public ListAddVehicleAdapter(Context context, List <GrowerModel> arrayList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_vehicle_input_model,null);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        try {
            ...
            if (position == 0) {
                holder.txt_1.setText("VECHILE TYPE");
                holder.txt_2.setText("Vehicle Number");
                holder.txt_3.setText("capacity");
               ...
               holder.txt_3.setTextColor(Color.parseColor("#FFFFFF"));
                ...
                holder.txt_1.setText(""+arrayList.get(pos).getRelation());
                holder.txt_2.setText(""+arrayList.get(pos).getVehicleNo());
                holder.txt_3.setText(""+arrayList.get(pos).getCapacity());
