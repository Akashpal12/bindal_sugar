...
import in.co.vibrant.bindalsugar.adapter.RaZoneWiseAreaReportListAdapter;
...
public class RaNonZoneWiseAreaReport extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaNonZoneWiseAreaReport.this;
        setTitle(getString(R.string.MENU_ZONE_WISE_AREA_REPORT));
        toolbar.setTitle(getString(R.string.MENU_ZONE_WISE_AREA_REPORT));
        ...
        fromdate_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(RaNonZoneWiseAreaReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private class getReportDetails extends AsyncTask<String, Integer, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/ZONEWISEAREA1";
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                else
                {
                    ...
                    header.setVillageCode(jsonObje.getString("ReportName"));
                    ...
                    for(int i=0;i<jsonArray.length();i++)
                    {
                        ...
                        growerModel.setVillageCode(jsonObject1.getString("ZoneName"));
            ...
            catch(JSONException e)
            {
                ...
                recyclerView.setHasFixedSize(true);
                recyclerView.setLayoutManager(manager);
                RaZoneWiseAreaReportListAdapter stockSummeryAdapter =new RaZoneWiseAreaReportListAdapter(context,staffTargetModelList);
                recyclerView.setAdapter(stockSummeryAdapter);
