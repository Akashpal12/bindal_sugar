...
import in.co.vibrant.bindalsugar.view.supervisor.PocPlotFinderMapView;
import in.co.vibrant.bindalsugar.view.supervisor.PocPlotsAllPlotsView;

public class POCPlotsAdapter extends RecyclerView.Adapter<POCPlotsAdapter.MyHolder> {

    private Context context;
    List<PocPlotsModel> arrayList;
    FusedLocationProviderClient fusedLocationClient;
    AlertDialog Alertdialog;


    public POCPlotsAdapter(Context context, List<PocPlotsModel> arrayList) {
        ...
        try {
           if (position == 0) {
                try {
                    ...
                    holder.poc_plot_code_name.setText(" Plot Code/Name");
                ...
                try {
                    ...
                    holder.poc_plot_code_name.setText(" "+arrayList.get(pos).getPOCM_CODE()+"/"+arrayList.get(pos).getPOCM_NAME());
                    holder.plot_village_code_name.setText(" "+arrayList.get(pos).getPLVILL()+"/"+arrayList.get(pos).getPLVILLNAME());
                    holder.plotsr_no.setText(" "+arrayList.get(pos).getPOC_PLOTNO());
                    ...
                    holder.view_all_plots_img.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            a.putExtra("V_CODE",arrayList.get(pos).getPLVILL());
                    ...
                    holder.plot_find_img.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(context, PocPlotFinderMapView.class);
                            intent.putExtra("lat",arrayList.get(pos).getGH_NE_LAT());
                            intent.putExtra("lng",arrayList.get(pos).getGH_NE_LNG());
                            intent.putExtra("PLOT_SELECTION",arrayList.get(pos).getPOCM_CODE());
    ...
    public void ShowMap(final PocPlotsModel model)
    {
        try{
