...
public class StaffServerPendingIndentReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Server Pending Indent");
        toolbar.setTitle("Server Pending Indent");
    ...
    {
        indentModelList=dbh.getIndentModel("No","","","","");
        RecyclerView recyclerView =findViewById(R.id.recycler_view);
        GridLayoutManager manager = new GridLayoutManager(StaffServerPendingIndentReport.this, 1, GridLayoutManager.VERTICAL, false);
        //recyclerView.setLayoutManager(manager);
        //gridLayoutManager=new GridLayoutManager(MainActivity.this,8,RecyclerView.HORIZONTAL,true);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(manager);
        ListPendingIndentAdapter listPloughingAdapter =new ListPendingIndentAdapter(StaffServerPendingIndentReport.this,indentModelList);
        recyclerView.setAdapter(listPloughingAdapter);
    }

    private void AlertPopUp(String msg) {
        android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.Builder(
                StaffServerPendingIndentReport.this);
