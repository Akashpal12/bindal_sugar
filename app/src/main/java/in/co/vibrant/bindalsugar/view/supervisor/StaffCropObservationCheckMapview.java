...
public class StaffCropObservationCheckMapview extends AppCompatActivity implements OnMapReadyCallback {
    DBHelper dbh;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= StaffCropObservationCheckMapview.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(StaffCropObservationCheckMapview.this);
    ...
    public void openVeritalCheckmapview(View v)
    {
        ...
        //intent.putExtra("lat", "28.9029715");
        //intent.putExtra("lng", "78.349518");
    ...
    private class GetMapData extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                //request1.addProperty("lat", "29.2078233333333");
                //request1.addProperty("lng", "78.2158766666667");
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if(plotFarmerShareArray.length()>0)
        {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(StaffCropObservationCheckMapview.this);
