...
import in.co.vibrant.bindalsugar.adapter.ListSoilSampleAdapter;
...
public class StaffSoilSampleList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= StaffSoilSampleList.this;
        ...
        setTitle(getString(R.string.MENU_SOIL_SAMPLE));
        toolbar.setTitle(getString(R.string.MENU_SOIL_SAMPLE));
            ...
            try{
                ...
                if(obj.getString("API_STATUS").equalsIgnoreCase("OK"))
                {
                    ...
                    if(jsonArray.length()==0)
                    {
                        ...
                        recyclerView.setLayoutManager(manager);
                        ListSoilSampleAdapter listGrowerFinderAdapter =new ListSoilSampleAdapter(context,dashboardData);
