...
import in.co.vibrant.bindalsugar.adapter.ListGetVillageWiseVarietyGroupSummeryAdapter;
...
public class VillageWiseVariertyGroupSummery extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.MENU_VILLAGE_WISE_VARIETY_GROUP_SUMMARY));
        toolbar.setTitle(getString(R.string.MENU_VILLAGE_WISE_VARIETY_GROUP_SUMMARY));
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(VillageWiseVariertyGroupSummery.this, RaSurveyDashboard.class);
                startActivity(intent);
                finish();
            }
        });
        if(new InternetCheck(VillageWiseVariertyGroupSummery.this).isOnline())
        {
            new GetDataList().execute(factory,SupvcodeFrom,SupvcodeTo,VillageFrom,VillageTo,FromDate,ToDate);
        }
        else
        {
            Toast.makeText(VillageWiseVariertyGroupSummery.this,getString(R.string.oops_connect_your_internet),Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void AlertPopUp(String msg) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                VillageWiseVariertyGroupSummery.this);
    ...
    private class GetDataList extends AsyncTask<String, Void, Void> {
        String message;
        private ProgressDialog dialog = new ProgressDialog(VillageWiseVariertyGroupSummery.this);

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = ProgressDialog.show(VillageWiseVariertyGroupSummery.this, getString(R.string.app_name),
                    "Please Wait ", true);
            dialog.show();
        }
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                SoapObject request1 = new SoapObject(APIUrl.NAMESPACE, APIUrl.method_SupervisorVarietyGroupAreaNew);
                ...
                androidHttpTransport.call(APIUrl.SOAP_ACTION_SupervisorVarietyGroupAreaNew, envelope);
                if (envelope.bodyIn instanceof SoapFault) {
                    SoapFault sf = (SoapFault) envelope.bodyIn;
                    message = sf.getMessage();
                } else {
                    SoapObject result = (SoapObject) envelope.bodyIn;
                    message = result.getPropertyAsString("SupervisorVarietyGroupAreaNewResult").toString();
                }
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                if (jsonArray.length() == 0) {
                        ...
                        for (int i = 0; i < villArray.length(); i++) {
                            ...
                            if (i > 0) {
                                ...
                                if (jsonObject1.getInt("SUPVCODE") == jsonObject.getInt("SUPVCODE")) {
                                    ...
                                    supData.put("PLANTPLOTS", jsonObject.getString("EARLYPLOTS"));
                                    supData.put("RATOONPLOTS", jsonObject.getString("REJECTEDPLOTS"));
                                    supData.put("AUTUMNPLOTS", jsonObject.getString("GENERALPLOTS"));
                                    supData.put("PLANTGROWER", jsonObject.getString("EARLYGROWER"));
                                    supData.put("RATOONGROWER", jsonObject.getString("GENERALGROWER"));
                                    supData.put("PLANTAREA", jsonObject.getString("EARLYAREA"));
                                    supData.put("RATOONAREA", jsonObject.getString("REJECTEDAREA"));
                                    supData.put("AUTUMNAREA", jsonObject.getString("GENERALAREA"));
                    ...
                    GridLayoutManager manager = new GridLayoutManager(VillageWiseVariertyGroupSummery.this, 1, RecyclerView.VERTICAL, false);
                    //recyclerView.setLayoutManager(manager);
                    //gridLayoutManager=new GridLayoutManager(MainActivity.this,8,RecyclerView.HORIZONTAL,true);
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setLayoutManager(manager);
                    ListGetVillageWiseVarietyGroupSummeryAdapter listGetCropTypeSummeryAdapter = new ListGetVillageWiseVarietyGroupSummeryAdapter(VillageWiseVariertyGroupSummery.this, jsonArray1);
            ...
            catch (JSONException e)
            {
                if(dialog.isShowing())
                    dialog.dismiss();
                new AlertDialogManager().AlertPopUpFinish(VillageWiseVariertyGroupSummery.this,message);
                //AlertPopUpFinish(message);
            }catch (Exception e)
            {
                new AlertDialogManager().AlertPopUpFinish(VillageWiseVariertyGroupSummery.this,"Error:"+e.toString());
            }
        }
    }
