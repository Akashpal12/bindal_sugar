...
public class PlotFinderMapViewMaster extends AppCompatActivity implements OnMapReadyCallback {
    DBHelper dbh;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = PlotFinderMapViewMaster.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(PlotFinderMapViewMaster.this);
    ...
    public void openVeritalCheckmapview(View v) {
        Intent intent = new Intent(context, PlotFinderListMaster.class);
        intent.putExtra("lat", "" + lat);
        intent.putExtra("lng", "" + lng);
        intent.putExtra("selectedColorCode", currentPlotColorCode);
        intent.putExtra("selectedDisease", currentPlotDisease);
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if (plotFarmerShareArray.length() > 0) {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(PlotFinderMapViewMaster.this);
