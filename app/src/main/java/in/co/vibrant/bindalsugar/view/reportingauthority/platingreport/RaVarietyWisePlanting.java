...
public class RaVarietyWisePlanting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaVarietyWisePlanting.this;
    ...
    public void openFiler(View v)
    {
        ...
        ArrayAdapter<String> adaptertypeOfPlanting = new ArrayAdapter<String>(RaVarietyWisePlanting.this,
    ...
    private class GenerateTables extends AsyncTask<Void, Integer, Void> {
        ...
        private final SoftReference<RaVarietyWisePlanting> activityReference;
        ...
        GenerateTables(Context context, String data) {
            ...
            activityReference = new SoftReference<>(RaVarietyWisePlanting.this);
        }
        ...
        protected void onPreExecute() {
            ...
            RaVarietyWisePlanting activity = activityReference.get();
    ...
    private void createTable(Context mContext,JSONArray jsonArray){
        try{
            ...
            textView4.setTypeface(typefaced8);
            ...
            textView11.setTypeface(typefaced);
            ...
            textView12.setTypeface(typefaced6);
            ...
            textView15.setTypeface(typefaced3);
            ...
            textView.setTypeface(typefaced2);
            ...
            textView1Sr.setTypeface(typefaced1);
    ...
    private class GetData extends AsyncTask<String, Integer, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/PLANTCDOVARIETYWISESEEDQTYACHIEVED";
