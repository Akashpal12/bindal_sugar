...
public class StaffServerUploadedPlantingReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Server Uploaded Planting");
        toolbar.setTitle("Server Uploaded Planting");
    ...
    {
        plantingModelList=dbh.getPlantingModel("DONE","","","","");
        RecyclerView recyclerView =findViewById(R.id.recycler_view);
        GridLayoutManager manager = new GridLayoutManager(StaffServerUploadedPlantingReport.this, 1, GridLayoutManager.VERTICAL, false);
        //recyclerView.setLayoutManager(manager);
        //gridLayoutManager=new GridLayoutManager(MainActivity.this,8,RecyclerView.HORIZONTAL,true);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(manager);
        ListPendingPlantingAdapter listPloughingAdapter =new ListPendingPlantingAdapter(StaffServerUploadedPlantingReport.this,plantingModelList);
    ...
    private void AlertPopUp(String msg) {
        android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.Builder(
                StaffServerUploadedPlantingReport.this);
