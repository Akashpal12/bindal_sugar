...
public class ListPlotActivityItemAdapter extends RecyclerView.Adapter<ListPlotActivityItemAdapter.MyHolder> {

    private Context context;
    List <MasterDropDown> arrayList;


    public ListPlotActivityItemAdapter(Context context, List <MasterDropDown> arrayList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_activity_input_model,null);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        try {
            if (position == 0) {
                holder.txt_1.setText("Code");
                holder.txt_2.setText("Name");
                ...
                holder.txt_1.setText(""+arrayList.get(pos).getCode());
                holder.txt_2.setText(""+arrayList.get(pos).getName());
