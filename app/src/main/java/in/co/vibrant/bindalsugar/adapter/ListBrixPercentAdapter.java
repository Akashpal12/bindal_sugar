...
public class ListBrixPercentAdapter extends RecyclerView.Adapter<ListBrixPercentAdapter.MyHolder> {

    private Context context;
    List <GrowerFinderModel> arrayList;


    public ListBrixPercentAdapter(Context context, List <GrowerFinderModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        holder.ivEdit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(ListBrixPercentAdapter.this.context, StaffAddBrixPercentagee.class);
                intent.putExtra("V_CODE", ListBrixPercentAdapter.this.arrayList.get(position).getVillageCode());
                intent.putExtra("G_CODE", ListBrixPercentAdapter.this.arrayList.get(position).getGrowerCode());
                intent.putExtra("PLOT_SR_NO", ListBrixPercentAdapter.this.arrayList.get(position).getPlotNo());
                intent.putExtra("GSRNO", ListBrixPercentAdapter.this.arrayList.get(position).getGrowerCode());
                intent.putExtra("PLOT_VILL", ListBrixPercentAdapter.this.arrayList.get(position).getPlotVillageCode());
                intent.putExtra("AREA", ListBrixPercentAdapter.this.arrayList.get(position).getCaneArea());
                intent.putExtra("SHARE_AREA", ListBrixPercentAdapter.this.arrayList.get(position).getPlotPercentage());
                intent.putExtra("G_NAME", ListBrixPercentAdapter.this.arrayList.get(position).getGrowerName());
                ((Activity) context ).finish();
                ListBrixPercentAdapter.this.context.startActivity(intent);
            }
        });
