...
public class PlotFarmerShareOldModel {

    public static final String SHARE_TABLE_NAME = "farmer_share_old";
    ...
    public static final String PLOT_TABLE_NAME = "plot_survey_old";
