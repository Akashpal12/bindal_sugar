...
import in.co.vibrant.bindalsugar.adapter.ListDoneIndentAdapter;
import in.co.vibrant.bindalsugar.model.IndentModel;
import in.co.vibrant.bindalsugar.model.UserDetailsModel;


public class StaffServerUploadedIndentReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Server Uploaded Indent");
        toolbar.setTitle("Server Uploaded Indent");
    ...
    {
        indentModelList=dbh.getIndentModel("Done","","","","");
        RecyclerView recyclerView =findViewById(R.id.recycler_view);
        GridLayoutManager manager = new GridLayoutManager(StaffServerUploadedIndentReport.this, 1, GridLayoutManager.VERTICAL, false);
        //recyclerView.setLayoutManager(manager);
        //gridLayoutManager=new GridLayoutManager(MainActivity.this,8,RecyclerView.HORIZONTAL,true);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(manager);
        ListDoneIndentAdapter listPloughingAdapter =new ListDoneIndentAdapter(StaffServerUploadedIndentReport.this,indentModelList);
        recyclerView.setAdapter(listPloughingAdapter);
    }

    private void AlertPopUp(String msg) {
        android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.Builder(
                StaffServerUploadedIndentReport.this);
