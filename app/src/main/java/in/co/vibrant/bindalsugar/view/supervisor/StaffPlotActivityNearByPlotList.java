...
public class StaffPlotActivityNearByPlotList extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context=StaffPlotActivityNearByPlotList.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(StaffPlotActivityNearByPlotList.this);
                        ...
                        public void onSuccess(Location location) {
                            ...
                            if (location != null) {
                                ...
                                try {
                                    if(lat>0)
                                    {
                                        plotFarmerShareModelList = dbh.getPlotActivityNearByLatLng(lat,lng);
        ...
        try {
            ...
            if (plotFarmerShareModelList.size() > 0) {
                for (int i = 0; i < plotFarmerShareModelList.size(); i++) {
                    ...
                    if(plotFarmerShareModelList.get(i).getPlotFrom().equalsIgnoreCase("Current Year Survey"))
                    {
                        polygonOptions.strokeColor(Color.parseColor("#000000"));
                        polygonOptions.fillColor(Color.parseColor("#6AFBED6A"));
                    }
                    else if(plotFarmerShareModelList.get(i).getPlotFrom().equalsIgnoreCase("Last Year Survey"))
                    {
                        polygonOptions.strokeColor(Color.parseColor("#000000"));
                        polygonOptions.fillColor(Color.parseColor("#593F51B5"));
                    }
                    else{
                        polygonOptions.strokeColor(Color.parseColor("#000000"));
                        polygonOptions.fillColor(Color.parseColor("#5CE91E63"));
                    }
                    //polygonOptions.strokeColor(Color.parseColor("#000000"));
                    //polygonOptions.fillColor(Color.parseColor("#6AFBED6A"));
                    ...
                    CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(StaffPlotActivityNearByPlotList.this);
    ...
    {
        Intent intent = new Intent(context, StaffPlotActivityList.class);
    ...
    private void AlertPopUp(String msg) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                StaffPlotActivityNearByPlotList.this);
