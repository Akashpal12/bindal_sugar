...
public class ListAddActivityAdapter extends RecyclerView.Adapter<ListAddActivityAdapter.MyHolder> {

    private Context context;
    List <GrowerModel> arrayList;


    public ListAddActivityAdapter(Context context, List <GrowerModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        try {
            ...
            if (position == 0) {
                holder.txt_1.setText("Grower Code");
                holder.txt_2.setText("Grower Father");
                holder.txt_4.setText("Grower Name");
                holder.txt_5.setText("Village Code");
               ...
               // holder.txt_3.setTextColor(Color.parseColor("#FFFFFF"));
                ...
                holder.txt_1.setText(""+arrayList.get(pos).getGrowerCode());
                holder.txt_2.setText(""+arrayList.get(pos).getGrowerFather());
                holder.txt_4.setText(""+arrayList.get(pos).getGrowerName());
                holder.txt_5.setText(""+arrayList.get(pos).getVillageCode());
