...
public class StaffActivityDetails extends AppCompatActivity  {

    DBHelper dbh;
    Context context;
    RelativeLayout caneLayout,potatoLayout;
    List<PotatoTodayActivityModal> potatoTodayActivityModalList;
    List<VillageModal> villageSurveyModelList;
    List<GrowerModel> growerSurveyModelList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= StaffActivityDetails.this;
    ...
    public void openPotatoActivities(View v)
    {
        ...
        new getPenddingActivityVillageWise().execute(villageSurveyModelList.get(village.getSelectedItemPosition()).getCode(),
                growerSurveyModelList.get(grower.getSelectedItemPosition()).getGrowerCode(),"P");
