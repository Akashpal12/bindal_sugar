...
public class RaStaffSurveyGrowerFinderMapView extends AppCompatActivity implements OnMapReadyCallback {
    DBHelper dbh;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaStaffSurveyGrowerFinderMapView.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(RaStaffSurveyGrowerFinderMapView.this);
        ...
        try {
            ...
            if (plotFarmerShareModelList.size() > 0) {
                for (int i = 0; i < plotFarmerShareModelList.size(); i++) {
                    ...
                    CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(RaStaffSurveyGrowerFinderMapView.this);
    ...
    private void AlertPopUp(String msg) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                RaStaffSurveyGrowerFinderMapView.this);
