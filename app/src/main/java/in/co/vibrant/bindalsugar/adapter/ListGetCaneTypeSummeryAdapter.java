...
public class ListGetCaneTypeSummeryAdapter extends RecyclerView.Adapter<ListGetCaneTypeSummeryAdapter.MyHolder> {

    private Context context;
    JSONArray jsonArray;


    public ListGetCaneTypeSummeryAdapter(Context context, JSONArray jsonArray) {
