...
import in.co.vibrant.bindalsugar.adapter.ListVeritalCheckAdapter;
...
public class StaffVeritalCheck extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= StaffVeritalCheck.this;
        ...
        setTitle("Verital Check");
        toolbar.setTitle("Verital Check");
            ...
            try{
                ...
                if(obj.getString("API_STATUS").equalsIgnoreCase("OK"))
                {
                    ...
                    if(jsonArray.length()==0)
                    {
                        ...
                        recyclerView.setLayoutManager(manager);
                        ListVeritalCheckAdapter listGrowerFinderAdapter =new ListVeritalCheckAdapter(context,dashboardData);
