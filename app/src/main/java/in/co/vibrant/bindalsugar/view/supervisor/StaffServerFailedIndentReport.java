...
import in.co.vibrant.bindalsugar.adapter.ListPendingIndentAdapter;
import in.co.vibrant.bindalsugar.model.IndentModel;
import in.co.vibrant.bindalsugar.model.UserDetailsModel;


public class StaffServerFailedIndentReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Server Failed Indent");
        toolbar.setTitle("Server Failed Indent");
    ...
    {
        indentModelList=dbh.getIndentModel("Failed","","","","");
        RecyclerView recyclerView =findViewById(R.id.recycler_view);
        GridLayoutManager manager = new GridLayoutManager(StaffServerFailedIndentReport.this, 1, GridLayoutManager.VERTICAL, false);
        //recyclerView.setLayoutManager(manager);
        //gridLayoutManager=new GridLayoutManager(MainActivity.this,8,RecyclerView.HORIZONTAL,true);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(manager);
        ListPendingIndentAdapter listPloughingAdapter =new ListPendingIndentAdapter(StaffServerFailedIndentReport.this,indentModelList);
    ...
    private void AlertPopUp(String msg) {
        android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.Builder(
                StaffServerFailedIndentReport.this);
