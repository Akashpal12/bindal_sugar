...
public class StaffCropObservationNearByPlotList extends AppCompatActivity implements OnMapReadyCallback {
    ...
    toolbar.setTitle(getString(R.string.MENU_NEARBY_PLOT));
        context= StaffCropObservationNearByPlotList.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(StaffCropObservationNearByPlotList.this);
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if(plotFarmerShareArray.length()>0)
        {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(StaffCropObservationNearByPlotList.this);
