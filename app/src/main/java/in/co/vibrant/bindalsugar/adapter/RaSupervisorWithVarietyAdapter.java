...
public class RaSupervisorWithVarietyAdapter extends RecyclerView.Adapter<RaSupervisorWithVarietyAdapter.MyHolder> {
    ...
    public RaSupervisorWithVarietyAdapter(Context context, List<ReportMultiple> arrayList) {
