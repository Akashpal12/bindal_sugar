...
public class RaCircleWithZoneReport extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaCircleWithZoneReport.this;
        ...
        fromdate_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(RaCircleWithZoneReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        new TargetList().execute(targetList.get(target_dd.getSelectedItemPosition()).getCode(),currentDate,currentDate);
    ...
    class TargetList extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/ZONECIRCLEWISEAREA";
                        ...
                        else
                        {
                            if(target.size()>0)
                            {
                                ...
                                for(int j=0;j<target.size();j++)
                                {
                                    ...
                                    map1.put("TargetArea",target.get(j).get("TargetArea"));
