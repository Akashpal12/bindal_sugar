...
import in.co.vibrant.bindalsugar.adapter.TodayActivityReportVillageWiseAdapter;
...
public class TodayActivityReportVillageWise extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= TodayActivityReportVillageWise.this;
        ...
        fromdate_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(TodayActivityReportVillageWise.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        new ONDATEAREAList().execute(typeOfPlantingList.get(planting_type.getSelectedItemPosition()).getCode(),currentDt,currentDt);
    ...
    public void getSpinner()
    {
        ...
        planting_type.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                {
                   // new ONDATEAREAList().execute(typeOfPlantingList.get(planting_type.getSelectedItemPosition()).getCode(),currentDate);
                }
                else
                {
    ...
    class ONDATEAREAList extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/GETACTIVITYVILLAGEWISEDAYTODAY";
        ...
        protected void onPostExecute(String sResponse) {
            ...
            try {
                ...
                if(jsonArray.length()>0)
                {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++)
                    {
                        ...
                        if(currentVillageCode.equalsIgnoreCase(jsonObject.getString("ATCODE")))
                        {
                            ...
                            map.put("VILLCODE",jsonObject.getString("VILLCODE"));
                            map.put("VILLNAME",jsonObject.getString("VILLNAME"));
                        ...
                        else
                        {
                            if(ONDATEAREA.size()>0)
                            {
                                ...
                                for(int j=0;j<ONDATEAREA.size();j++)
                                {
                                    ...
                                    map1.put("VILLCODE",ONDATEAREA.get(j).get("VILLCODE"));
                                    map1.put("VILLNAME",ONDATEAREA.get(j).get("VILLNAME"));
                ...
                TodayActivityReportVillageWiseAdapter adapter =new TodayActivityReportVillageWiseAdapter(context,ONDATEAREAFinal);
