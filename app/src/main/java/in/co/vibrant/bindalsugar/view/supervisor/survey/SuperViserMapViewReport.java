...
public class SuperViserMapViewReport extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            sessionConfig = new SessionConfig(SuperViserMapViewReport.this);
            ...
            village_code = getIntent().getExtras().getString("village_code");
            tv_grower = getIntent().getExtras().getString("tv_grower");

            SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                    .findFragmentById(R.id.map);
            mapFragment.getMapAsync(SuperViserMapViewReport.this);
    ...
    private class GetMapData extends AsyncTask<String, Void, Void> {
        String message;
        private ProgressDialog dialog = new ProgressDialog(SuperViserMapViewReport.this);

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = ProgressDialog.show(SuperViserMapViewReport.this, getString(R.string.app_name),
                    "Please Wait ", true);
            dialog.show();
        }
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                SoapObject request1 = new SoapObject(APIUrl.NAMESPACE, APIUrl.method_GETMAPDATASUP_NEW1);
                request1.addProperty("Divn", userDetailsModelList.get(0).getDivision());
                request1.addProperty("VillageCode", village_code);//villageCode
                request1.addProperty("GrowerCode", growerCode);//growerCode
                request1.addProperty("Season", ""+sessionConfig.getSeason());
                ...
                androidHttpTransport.call(APIUrl.SOAP_ACTION_GETMAPDATASUP_NEW1, envelope);
                if (envelope.bodyIn instanceof SoapFault) {
                    SoapFault sf = (SoapFault) envelope.bodyIn;
                    message = sf.getMessage();
                } else {
                    SoapObject result = (SoapObject) envelope.bodyIn;
                    message = result.getPropertyAsString("GETMAPDATASUP_NEW1Result").toString();
                }
        ...
        protected void onPostExecute(Void result) {
            ...
            try{
                ...
                if(plotFarmerShareArray.length()>0)
                {
                    for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                        ...
                        CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(SuperViserMapViewReport.this);
            ...
            {
                new AlertDialogManager().AlertPopUpFinish(SuperViserMapViewReport.this,message);
                //AlertPopUpFinish(message);
            }catch (Exception e)
            {
                new AlertDialogManager().AlertPopUpFinish(SuperViserMapViewReport.this,"Error:"+e.toString());
            }
        }
    }
