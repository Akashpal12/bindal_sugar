...
public class StaffSurveyReportCaneTypeSummery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.MENU_CANE_TYPE_SUMMARY_REPORT));
        ...
        try {
            ...
            reportCaneTypeSummeryModelList = dbh.getReportCaneTypeSummery(villageCode, fromDate, toDate);
            ...
            GridLayoutManager manager = new GridLayoutManager(StaffSurveyReportCaneTypeSummery.this, 1, GridLayoutManager.VERTICAL, false);
            //recyclerView.setLayoutManager(manager);
            //gridLayoutManager=new GridLayoutManager(MainActivity.this,8,RecyclerView.HORIZONTAL,true);
            recyclerView.setHasFixedSize(true);
            recyclerView.setLayoutManager(manager);
            ReportCaneTypeSummeryListAdapter stockSummeryAdapter = new ReportCaneTypeSummeryListAdapter(StaffSurveyReportCaneTypeSummery.this, reportCaneTypeSummeryModelList1);
            recyclerView.setAdapter(stockSummeryAdapter);
        }
        catch (Exception e)
        {
            new AlertDialogManager().RedDialog(StaffSurveyReportCaneTypeSummery.this,"Error:"+e.toString());
        }
    }

    private void AlertPopUp(String msg) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                StaffSurveyReportCaneTypeSummery.this);
    ...
    public void printData(View v)
    {
        try {
            ...
            int i = 1;
            //while (true) {\
            Intent intent = new Intent(StaffSurveyReportCaneTypeSummery.this, BluetoothChat.class);
