...
public class StaffBrixPercentNearByPlotList extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= StaffBrixPercentNearByPlotList.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(StaffBrixPercentNearByPlotList.this);
    ...
    {
        Intent intent = new Intent(context, StaffBrixPercent.class);
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if(plotFarmerShareArray.length()>0)
        {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(StaffBrixPercentNearByPlotList.this);
