...
public class AddFormActivity extends AppCompatActivity implements MFS100Event {
    private static final String TAG = "AddFormActivity";
    TextView  tv_VillageCode, tv_growerCode, tv_Name, tv_growerFatherName;
    private List<VillageSurveyModel> villageMasterModels = new ArrayList<>();
    private List<VillageModal> villageMasterModel = new ArrayList<>();
    ...
    VillageAutoSearchAdapter villageSearchListAdapter = null;
    VillageSearchListAdapter villageSearchListAdapter1=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            mfs100.SetApplicationContext(AddFormActivity.this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void init() {
        ...
        try {
            if (db != null) {
                ...
                villageMasterModels.addAll(db.getVillageModel(""));
        ...
        villageSearchListAdapter = new VillageAutoSearchAdapter(this, R.layout.all_list_row_item_search, villageMasterModels);
        ...
        autoTV_villageCode.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        VillageSurveyModel mVillgModel = (VillageSurveyModel) parent.getItemAtPosition(position);
                        mVillageCodeSalected = mVillgModel.getVillageCode();
                        mVillageNameSalected = mVillgModel.getVillageName();
                        autoTV_villageCode.setText(mVillgModel.getVillageCode() + "-" + mVillgModel.getVillageName());
                        tv_VillageCode.setText(mVillgModel.getVillageCode() + "-" + mVillgModel.getVillageCode());
                        growerMasterModels.clear();
                        growerMasterModels.addAll(db.getGrowerModel(mVillageCodeSalected,""));
                        gAdaper = new GrowerSearchListAdapter(AddFormActivity.this, R.layout.all_list_row_item_search_grower, growerMasterModels);
                        autoTV_growerCode.setThreshold(1);
                        autoTV_growerCode.setAdapter(gAdaper);
                        Log.d(TAG, "onItemClick: " + mVillgModel.getVillageName());
                    }
                });
        ...
        btn_save_signature.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (UtilFile.checkRequestPermiss(getApplicationContext(), AddFormActivity.this)) {
                    isClicked = "Signature";
                                       ...
                                       /* if (byteArrayThumb != null)
                                        {*/
                                            if (db != null) {
                                                ...
                                                new AlertDialogManager().showToast(AddFormActivity.this, getResources().getString(R.string.save_sucee));
                                                signaturePad.clear();
                                        ...
                                        /*else
                                        {
                                            new AlertDialogManager().showToast(AddFormActivity.this, "Thumb not found");
                                        }*/
                                    } else {
                                        new AlertDialogManager().showToast(AddFormActivity.this, "Signature not found");
                                    }
                                } else {
                                    new AlertDialogManager().showToast(AddFormActivity.this, "Please select photo 2");
                                }
                            } else {
                                new AlertDialogManager().showToast(AddFormActivity.this, "Please select photo 1");
                            }
                        } else {
                            new AlertDialogManager().showToast(AddFormActivity.this, getResources().getString(R.string.enter_grower));
                        }
                    } else {
                        new AlertDialogManager().showToast(AddFormActivity.this, getResources().getString(R.string.enter_village));
                    }
    ...
    private void getGoToNextActivty() {
        Intent intent = new Intent(AddFormActivity.this, AddFormDetailActivity.class);
    ...
    private void getBottomSheet1() {
        ...
        lLayRemove_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (byteArray_photo_1 == null) {
                    new AlertDialogManager().showToast(AddFormActivity.this, "Please choose photo 1");
                } else {
                    ivPhoto_1.setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_image_24));
                    byteArray_photo_1 = null;
                    new AlertDialogManager().showToast(AddFormActivity.this, "Successfully Removed photo 1");
                    dialog_1.dismiss();
                }
            }
        });
    ...
    private void getBottomSheet2() {
        ...
        lLayRemove_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (byteArray_photo_2 == null) {
                    new AlertDialogManager().showToast(AddFormActivity.this, "Please choose photo 2");
                } else {
                    ivPhoto_2.setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_image_24));
                    byteArray_photo_2 = null;
                    new AlertDialogManager().showToast(AddFormActivity.this, "Successfully Removed photo 2");
                    dialog_2.dismiss();
                }
            }
        });
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            switch (which) {
                                                case DialogInterface.BUTTON_POSITIVE:
                                                    UtilFile.checkRequestPermiss(getApplicationContext(), AddFormActivity.this);
                                                    break;
    ...
    private void detectFaces(FirebaseVisionImage image) {
        try {
            FirebaseApp.initializeApp(AddFormActivity.this);
                                            ...
                                            if(faces.size()>0)
                                            {
                                                for (FirebaseVisionFace face : faces) {
                                                    ...
                                                    else
                                                    {
                                                        ivPhoto_1.setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_person_outline_24));
                                                        byteArray_photo_1 = null;
                                                        new AlertDialogManager().showToast(AddFormActivity.this, "Sorry face not detected on captured image");
                                                    }
...
//                        Log.e("FingerISOTemplate", Base64.encodeToString(fingerData.ISOTemplate(), Base64.DEFAULT));
 ...
 /*   class SAVEGROWERDOCUMENTDATA extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            dialog = ProgressDialog.show(contex, "Uploading",
        ...
        protected String doInBackground(String... params) {
            try {
                GetDeviceImei getDeviceImei = new GetDeviceImei(AddFormActivity.this);
                String url = loginUserDetailsList.get(0).getFactoryUrl() + "/SAVEGROWERDOCUMENTDATA";
                ...
                entity.add(new BasicNameValuePair("IMEI_NO", getDeviceImei.GetDeviceImeiNumber()));
                entity.add(new BasicNameValuePair("VILLAGE_CODE", inputFormList.get(0).getAgriVillageCode()));
                entity.add(new BasicNameValuePair("GROWER_CODE", inputFormList.get(0).getAgriGrowerCode()));
                entity.add(new BasicNameValuePair("SuperviserCode", loginUserDetailsList.get(0).getUserId()));
                ...
                entity.add(new BasicNameValuePair("MEMBERLIST", inputFormList.get(0).getGrowerJson()));
                entity.add(new BasicNameValuePair("ACKID", "" + inputFormList.get(0).getAgri_input_Id()));
                entity.add(new BasicNameValuePair("APPCRDATE", "" + inputFormList.get(0).getCreated_at()));
        ...
        protected void onPostExecute(String sResponse) {
            try {
                ...
                {
                    db.updateAgriInputFormModel(jsonObject.getString("EXCEPTIONMSG"), jsonObject.getString("ACKID"), "Failed");
                    // db.updateAgriInputFormModel(jsonObject.getString("EXCEPTIONMSG").replace("'",""),jsonObject.getString("ACKID"),jsonObject.getString("SAVEMSG"));
