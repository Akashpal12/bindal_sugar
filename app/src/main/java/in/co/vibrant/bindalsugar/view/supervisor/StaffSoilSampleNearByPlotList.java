...
public class StaffSoilSampleNearByPlotList extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= StaffSoilSampleNearByPlotList.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(StaffSoilSampleNearByPlotList.this);
    ...
    {
        Intent intent = new Intent(context, StaffSoilSampleList.class);
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if(plotFarmerShareArray.length()>0)
        {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(StaffSoilSampleNearByPlotList.this);
