...
import in.co.vibrant.bindalsugar.adapter.RaVillageWithVarietyAdapter;
...
public class ReportVillageWithVarietyReport extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= ReportVillageWithVarietyReport.this;
        setTitle(getString(R.string.MENU_VILLAGE_WISE_VARIETY_REPORT));
        toolbar.setTitle(getString(R.string.MENU_VILLAGE_WISE_VARIETY_REPORT));
        ...
        fromdate_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(ReportVillageWithVarietyReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    class TargetList extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/PLANTSUPVILLAGEVARIETYWISESEEDQTYACHIEVED";
        ...
        protected void onPostExecute(String sResponse) {
            ...
            try {
                ...
                RaVillageWithVarietyAdapter stockSummeryAdapter =new RaVillageWithVarietyAdapter(context,targetFinal);
