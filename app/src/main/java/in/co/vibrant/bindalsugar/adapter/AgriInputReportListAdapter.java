...
public class AgriInputReportListAdapter extends RecyclerView.Adapter<AgriInputReportListAdapter.MyHolder> {
    ...
    public AgriInputReportListAdapter(Context context, List <StaffTargetModel> arrayList) {
