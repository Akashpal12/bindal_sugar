...
public class PlotFinderMapViewGrowerFinder extends AppCompatActivity implements OnMapReadyCallback {
    DBHelper dbh;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_staff_grower_finder_mapview);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        setTitle("Near By Plot View");
        context= PlotFinderMapViewGrowerFinder.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(PlotFinderMapViewGrowerFinder.this);
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if(plotFarmerShareArray.length()>0)
        {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(PlotFinderMapViewGrowerFinder.this);
