...
public class RaNonSupervisorAreaReportListAdapter extends RecyclerView.Adapter<RaNonSupervisorAreaReportListAdapter.MyHolder> {
    ...
    public RaNonSupervisorAreaReportListAdapter(Context context, List <StaffTargetModel> arrayList) {
