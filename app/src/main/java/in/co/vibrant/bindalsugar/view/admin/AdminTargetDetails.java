...
import in.co.vibrant.bindalsugar.adapter.AdminTargetDetailsAdapter;
...
import in.co.vibrant.bindalsugar.view.supervisor.StaffDevelopmentDashboard;
import in.co.vibrant.bindalsugar.view.supervisor.StaffGrowerDetailsDashboard;


public class AdminTargetDetails extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_activity_target_details);
        ...
        AdminTargetDetailsAdapter staffTargetSummeryAdapter =new AdminTargetDetailsAdapter(context,staffTargetModalList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_language) {
            Intent mapIntent=new Intent(AdminTargetDetails.this, LanguageSettings.class);
            startActivity(mapIntent);
            return true;
        }
        else if (id == R.id.action_logout) {
            Intent mapIntent=new Intent(AdminTargetDetails.this, Home.class);
            startActivity(mapIntent);
            return true;
        }
