...
import in.co.vibrant.bindalsugar.adapter.ListCropObservationAdapter;
...
public class StaffCropObservation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= StaffCropObservation.this;
        ...
        setTitle(getString(R.string.MENU_CROP_OBSERVATION));
       toolbar. setTitle(getString(R.string.MENU_CROP_OBSERVATION));
            ...
            try{
                ...
                if(obj.getString("API_STATUS").equalsIgnoreCase("OK"))
                {
                    ...
                    if(jsonArray.length()==0)
                    {
                        ...
                        recyclerView.setLayoutManager(manager);
                        ListCropObservationAdapter listGrowerFinderAdapter =new ListCropObservationAdapter(context,dashboardData);
