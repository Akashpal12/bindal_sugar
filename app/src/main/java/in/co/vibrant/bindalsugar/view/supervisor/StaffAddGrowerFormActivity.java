...
public class StaffAddGrowerFormActivity extends AppCompatActivity implements MFS100Event {
    ...
    Button btnChoosePhoto_1,save, btnChoosePhoto_2, btnCancel_1, btnCancel_2, btn_save_signature, btn_clear_signature, btn_save_add_form;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contex= StaffAddGrowerFormActivity.this;
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(StaffAddGrowerFormActivity.this,StaffDevelopmentDashboard.class);
        ...
        try {
            ...
            mfs100.SetApplicationContext(StaffAddGrowerFormActivity.this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void init() {
        ...
        autoTV_villageCode.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        gAdaper = new GrowerSearchListAdapter(StaffAddGrowerFormActivity.this, R.layout.all_list_row_item_search_grower, growerMasterModels);
        ...
        btn_save_signature.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (UtilFile.checkRequestPermiss(getApplicationContext(), StaffAddGrowerFormActivity.this)) {
                    isClicked = "Signature";
                                    ...
                                    if (byteArraySignature != null) {
                                        if (byteArrayThumb != null)
                                        {
                                            if (db != null) {
                                                ...
                                                new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, getResources().getString(R.string.save_sucee));
                                                signaturePad.clear();
                                        ...
                                        {
                                            new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, "Thumb not found");
                                        }
                                    } else {
                                        new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, "Signature not found");
                                    }
                                } else {
                                    new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, "Please select photo 2");
                                }
                            } else {
                                new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, "Please select photo 1");
                            }
                        } else {
                            new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, getResources().getString(R.string.enter_grower));
                        }
                    } else {
                        new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, getResources().getString(R.string.enter_village));
                    }
    ...
    private void getGoToNextActivty() {
        Intent intent = new Intent(StaffAddGrowerFormActivity.this, StaffAddGrowerFormDetailActivity.class);
        startActivity(intent);
    ...
    private void getBottomSheet1() {
        ...
        lLayRemove_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (byteArray_photo_1 == null) {
                    new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, "Please choose photo 1");
                } else {
                    ivPhoto_1.setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_image_24));
                    byteArray_photo_1 = null;
                    new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, "Successfully Removed photo 1");
                    dialog_1.dismiss();
                }
            }
        });
    ...
    private void getBottomSheet2() {
        ...
        lLayRemove_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (byteArray_photo_2 == null) {
                    new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, "Please choose photo 2");
                } else {
                    ivPhoto_2.setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_image_24));
                    byteArray_photo_2 = null;
                    new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, "Successfully Removed photo 2");
                    dialog_2.dismiss();
                }
            }
        });
  ...
  private void SaveAllDataInDB()
                ...
                if (byteArray_photo_1 != null) {
                    if (byteArray_photo_2 != null) {
                        if (byteArraySignature != null) {
                            ...
                            {
                                if (db != null) {
                                    int mAddAgriInputID = (int) db.insertSaveGrowerDocumentModel(mVillageCodeSalected, mVillageNameSalected, mGrowerCodeSalected, mSelectedName, "", mSelectedFather, "", byteArray_photo_1, byteArray_photo_2, byteArraySignature, byteArrayThumb,  UtilFile.myTableId);
                                    Log.d(TAG, "onClick: " + ">>>>>>>" + "New Record" + mAddAgriInputID);
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            switch (which) {
                                                case DialogInterface.BUTTON_POSITIVE:
                                                    UtilFile.checkRequestPermiss(getApplicationContext(), StaffAddGrowerFormActivity.this);
                                                    break;
    ...
    private void detectFaces(FirebaseVisionImage image) {
        try {
            FirebaseApp.initializeApp(StaffAddGrowerFormActivity.this);
                                            ...
                                            if(faces.size()>0)
                                            {
                                                for (FirebaseVisionFace face : faces) {
                                                    ...
                                                    else
                                                    {
                                                        ivPhoto_1.setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_person_outline_24));
                                                        byteArray_photo_1 = null;
                                                        new AlertDialogManager().showToast(StaffAddGrowerFormActivity.this, "Sorry face not detected on captured image");
                                                    }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (ret != 0) {
                        ...
                        StaffAddGrowerFormActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
