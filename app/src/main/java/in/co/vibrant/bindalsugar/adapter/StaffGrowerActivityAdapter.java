...
public class StaffGrowerActivityAdapter extends RecyclerView.Adapter<StaffGrowerActivityAdapter.MyHolder> {
    ...
    public StaffGrowerActivityAdapter(Context context, List<GrowerActivityDetailsModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        for (int j = 0; j < jsonArray.length() ; j++) {
            try {
                ...
                tv8.setImageResource(R.drawable.ic_baseline_image_24);
