...
public class StaffGrowerTargetReportListAdapter extends RecyclerView.Adapter<StaffGrowerTargetReportListAdapter.MyHolder> {

    private Context context;
    List <StaffGrowerTargetModel> arrayList;
    AlertDialog Alertdialog;


    public StaffGrowerTargetReportListAdapter(Context context, List <StaffGrowerTargetModel> arrayList) {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_report_grower_target_list,null);
    ...
    public void onBindViewHolder(MyHolder holder, final int position) {
        try {
            ...
            if(position==0)
            {
                holder.txt1.setText("Grower");
                holder.txt2.setText("Father");
                holder.txt3.setText("Variety");
                holder.txt4.setText("Manual Area");
                holder.txt5.setText("GPS Area");
                holder.txt6.setText("Date");
                holder.txt7.setText("Village");
            }
            else
            {
                holder.txt1.setText(arrayList.get(position).getGrowerCode()+"/"+arrayList.get(position).getGrowerName());
                holder.txt2.setText(arrayList.get(position).getFatherName());
                holder.txt3.setText(arrayList.get(position).getVarietyCode()+"/"+arrayList.get(position).getVarietyName());
                holder.txt4.setText(arrayList.get(position).getManualArea());
                holder.txt5.setText(arrayList.get(position).getArea());
                holder.txt6.setText(arrayList.get(position).getIndDate());
                holder.txt7.setText(arrayList.get(position).getVillageCode()+"/"+arrayList.get(position).getVillageName());
            }
