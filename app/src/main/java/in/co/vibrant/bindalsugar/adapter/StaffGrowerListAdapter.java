...
import in.co.vibrant.bindalsugar.view.supervisor.StaffGrowerPlotDetails;


public class StaffGrowerListAdapter extends RecyclerView.Adapter<StaffGrowerListAdapter.MyHolder> {
    ...
    public StaffGrowerListAdapter(Context context, List <GrowerModel> arrayList) {
