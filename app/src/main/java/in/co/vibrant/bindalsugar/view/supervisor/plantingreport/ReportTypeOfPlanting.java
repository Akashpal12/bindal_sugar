...
public class ReportTypeOfPlanting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= ReportTypeOfPlanting.this;
    ...
    public void openFiler(View v)
    {
        ...
        ArrayAdapter<String> adaptertypeOfPlanting = new ArrayAdapter<String>(ReportTypeOfPlanting.this,
    ...
    private class GenerateTables extends AsyncTask<Void, Integer, Void> {
        ...
        private final SoftReference<ReportTypeOfPlanting> activityReference;
        ...
        GenerateTables(Context context, String data) {
            ...
            activityReference = new SoftReference<>(ReportTypeOfPlanting.this);
        }
        ...
        protected void onPreExecute() {
            ...
            ReportTypeOfPlanting activity = activityReference.get();
    ...
    private void createTable(Context mContext,JSONArray jsonArray){
        try{
            ...
            for (int i = 0; i <jsonArray.length(); i++) {
                ...
                textView1.setTypeface(typefacetotalToDateArea);
                ...
                Typeface typeface1 = ResourcesCompat.getFont(this, R.font.roboto_black);
                ...
                Typeface typeface3= ResourcesCompat.getFont(this, R.font.roboto_black);
            ...
            Typeface typeface4 = ResourcesCompat.getFont(this, R.font.roboto_black);
    ...
    private class GetData extends AsyncTask<String, Integer, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/PLANTTYPESUPWISETARGET";
