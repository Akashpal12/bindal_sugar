...
import in.co.vibrant.bindalsugar.adapter.AdminMainActivityDataAdapter;
...
public class AdminMainActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdminMainActivityDataAdapter staffTargetSummeryAdapter =new AdminMainActivityDataAdapter(context,staffTargetModalList);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_language) {
            Intent mapIntent=new Intent(AdminMainActivity.this, LanguageSettings.class);
            startActivity(mapIntent);
            return true;
        }
        else if (id == R.id.action_logout) {
            Intent mapIntent=new Intent(AdminMainActivity.this, Home.class);
            startActivity(mapIntent);
            return true;
        }
