...
public class RaZoneWithVarietyAdapter extends RecyclerView.Adapter<RaZoneWithVarietyAdapter.MyHolder> {
    ...
    public RaZoneWithVarietyAdapter(Context context, JSONArray arrayList) {
