...
public class ListSoilSampleAdapter extends RecyclerView.Adapter<ListSoilSampleAdapter.MyHolder> {

    private Context context;
    List <GrowerFinderModel> arrayList;


    public ListSoilSampleAdapter(Context context, List <GrowerFinderModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        holder.ivEdit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(ListSoilSampleAdapter.this.context, SoilSampleCollect.class);
                intent.putExtra("V_CODE", ListSoilSampleAdapter.this.arrayList.get(position).getVillageCode());
                intent.putExtra("V_NAME", ListSoilSampleAdapter.this.arrayList.get(position).getVillageName());
                intent.putExtra("G_CODE", ListSoilSampleAdapter.this.arrayList.get(position).getGrowerCode());
                intent.putExtra("PLOT_SR_NO", ListSoilSampleAdapter.this.arrayList.get(position).getPlotNo());
                intent.putExtra("GSRNO", ListSoilSampleAdapter.this.arrayList.get(position).getGrowerCode());
                intent.putExtra("PLOT_VILL", ListSoilSampleAdapter.this.arrayList.get(position).getPlotVillageCode());
                intent.putExtra("AREA", ListSoilSampleAdapter.this.arrayList.get(position).getCaneArea());
                intent.putExtra("SHARE_AREA", ListSoilSampleAdapter.this.arrayList.get(position).getPlotPercentage());
                intent.putExtra("G_NAME", ListSoilSampleAdapter.this.arrayList.get(position).getGrowerName());
                ((Activity) context ).finish();
                ListSoilSampleAdapter.this.context.startActivity(intent);
            }
        });
