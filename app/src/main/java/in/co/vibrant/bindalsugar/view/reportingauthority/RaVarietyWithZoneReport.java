...
public class RaVarietyWithZoneReport extends AppCompatActivity  {
   ...
   EditText fromdate_select,todate_selects;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaVarietyWithZoneReport.this;
        setTitle(getString(R.string.MENU_VARIETY_WITH_ZONE_REPORT));
        toolbar.setTitle(getString(R.string.MENU_VARIETY_WITH_ZONE_REPORT));
        ...
        fromdate_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(RaVarietyWithZoneReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    class TargetList extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/VARIETYZONEWISEAREA";
        ...
        protected void onPostExecute(String sResponse) {
            ...
            try {
                ...
                if(jsonArray.length()>0)
                {
                    ...
                    currentVarietyName = jsonObject1.getString("VRNAME");
                    List<Map<String,String>> target=new ArrayList<>();
                    for (int i = 0; i < jsonArray.length(); i++)
                    {
                        JSONObject jsonObject=jsonArray.getJSONObject(i);
                        if(currentVarietyName.equalsIgnoreCase(jsonObject.getString("VRNAME")))
                        {
                        ...
                        else
                        {
                            if(target.size()>0)
                            {
                                ...
                                currentVarietyName = jsonObject.getString("VRNAME");
                                target.clear();
                            }
                            Map<String,String> map =new HashMap<String, String>();
                            map.put("VRNAME",jsonObject.getString("VRNAME"));
