...
public class TotalKmAdapter extends RecyclerView.Adapter<TotalKmAdapter.MyHolder> {

    private Context context;
    List<TruckInCentreModal> arrayList;
    AlertDialog Alertdialog;

    public TotalKmAdapter(Context context, List<TruckInCentreModal> arrayList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_total_km,null);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        holder.km.setText(arrayList.get(position).getTotalKm());
        ...
        holder.km.setTextColor(Color.parseColor(arrayList.get(position).getColor()));
    ...
    {
        ImageView ivCall;
        TextView centre_code,centre_name,truck_number,driver_name,driver_number,km;
