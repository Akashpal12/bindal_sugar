...
import in.co.vibrant.bindalsugar.view.supervisor.StaffVerticalCheckMapview;

public class StaffSurveyVerticalCheckMapView extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_staff_survey_vertical_check_map_view);
        ...
        context= StaffSurveyVerticalCheckMapView.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(StaffSurveyVerticalCheckMapView.this);
    ...
    public void opensurveyVerticalcheckmapview(View v)
    {
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if(plotFarmerShareArray.length()>0)
        {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(StaffSurveyVerticalCheckMapView.this);
