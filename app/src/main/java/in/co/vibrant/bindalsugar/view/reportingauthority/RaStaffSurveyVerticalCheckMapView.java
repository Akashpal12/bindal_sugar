...
import in.co.vibrant.bindalsugar.view.supervisor.StaffVeritalCheck;

public class RaStaffSurveyVerticalCheckMapView extends AppCompatActivity implements OnMapReadyCallback {
    DBHelper dbh;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaStaffSurveyVerticalCheckMapView.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(RaStaffSurveyVerticalCheckMapView.this);
        ...
        try {
            ...
            if (plotFarmerShareModelList.size() > 0) {
                for (int i = 0; i < plotFarmerShareModelList.size(); i++) {
                    ...
                    CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(RaStaffSurveyVerticalCheckMapView.this);
    ...
    private void AlertPopUp(String msg) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                RaStaffSurveyVerticalCheckMapView.this);
