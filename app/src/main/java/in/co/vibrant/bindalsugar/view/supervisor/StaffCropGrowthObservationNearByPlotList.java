...
public class StaffCropGrowthObservationNearByPlotList extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= StaffCropGrowthObservationNearByPlotList.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(StaffCropGrowthObservationNearByPlotList.this);
    ...
    {
        Intent intent = new Intent(context, StaffCropGrowthObservation.class);
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if(plotFarmerShareArray.length()>0)
        {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(StaffCropGrowthObservationNearByPlotList.this);
