...
public class RaOndateTodateTypeOfPlanting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaOndateTodateTypeOfPlanting.this;
    ...
    public void openFiler(View v)
    {
        ...
        ArrayAdapter<String> adaptertypeOfPlanting = new ArrayAdapter<String>(RaOndateTodateTypeOfPlanting.this,
    ...
    private class GenerateTables extends AsyncTask<Void, Integer, Void> {
        ...
        private final SoftReference<RaOndateTodateTypeOfPlanting> activityReference;
        ...
        GenerateTables(Context context, String data) {
            ...
            activityReference = new SoftReference<>(RaOndateTodateTypeOfPlanting.this);
        }
        ...
        protected void onPreExecute() {
            ...
            RaOndateTodateTypeOfPlanting activity = activityReference.get();
    ...
    private void createTable(Context mContext,JSONArray jsonArray){
        try{
            ...
            for (int i = 0; i <jsonArray.length(); i++) {
                ...
                Typeface typefaced00 = ResourcesCompat.getFont(context, R.font.roboto_black);
                textView2.setTypeface(typefaced00);
                ...
                Typeface typefaced1222 = ResourcesCompat.getFont(context, R.font.roboto_black);
                textView3.setTypeface(typefaced1222);
                ...
                Typeface typefaced122 = ResourcesCompat.getFont(context, R.font.roboto_black);
                textView4.setTypeface(typefaced122);
            ...
            textView1.setTypeface(typefaced12);
            textView1.setTextColor(getResources().getColor(R.color.black));
            ...
            Typeface typefaced111 = ResourcesCompat.getFont(context, R.font.roboto_black);
            textView2.setTypeface(typefaced111);
            ...
            Typeface typefaced16 = ResourcesCompat.getFont(context, R.font.roboto_black);
            textView4.setTypeface(typefaced16);
            ...
            textView5.setTypeface(typefaced11);
            ...
            textView12.setTypeface(typefaced0);
            ...
            textView13.setTypeface(typefaced1);
            ...
            textView14.setTypeface(typefaced22);
            ...
            textView.setTypeface(typefaced99);
            //textView.setBackgroundResource(R.drawable.list_border);
            textView.setPadding(5 ,5,5,5);
            textView.setTextSize(textSize);
            textView.setTextColor(getResources().getColor(R.color.black));
            ...
            textView1Sr.setTypeface(typefaced03);
    ...
    private class GetData extends AsyncTask<String, Integer, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/PLANTTYPESUPWISETARGETONTODATECDO";
