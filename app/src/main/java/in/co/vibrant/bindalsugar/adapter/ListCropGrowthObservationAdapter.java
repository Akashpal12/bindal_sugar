...
public class ListCropGrowthObservationAdapter extends RecyclerView.Adapter<ListCropGrowthObservationAdapter.MyHolder> {

    private Context context;
    List <GrowerFinderModel> arrayList;


    public ListCropGrowthObservationAdapter(Context context, List <GrowerFinderModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        holder.ivEdit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(ListCropGrowthObservationAdapter.this.context, StaffAddCropGrowthObservation.class);
                intent.putExtra("V_CODE", ListCropGrowthObservationAdapter.this.arrayList.get(position).getVillageCode());
                intent.putExtra("G_CODE", ListCropGrowthObservationAdapter.this.arrayList.get(position).getGrowerCode());
                intent.putExtra("PLOT_SR_NO", ListCropGrowthObservationAdapter.this.arrayList.get(position).getPlotNo());
                intent.putExtra("GSRNO", ListCropGrowthObservationAdapter.this.arrayList.get(position).getGrowerCode());
                intent.putExtra("PLOT_VILL", ListCropGrowthObservationAdapter.this.arrayList.get(position).getPlotVillageCode());
                intent.putExtra("AREA", ListCropGrowthObservationAdapter.this.arrayList.get(position).getCaneArea());
                intent.putExtra("SHARE_AREA", ListCropGrowthObservationAdapter.this.arrayList.get(position).getPlotPercentage());
                intent.putExtra("G_NAME", ListCropGrowthObservationAdapter.this.arrayList.get(position).getGrowerName());
                ((Activity) context ).finish();
                ListCropGrowthObservationAdapter.this.context.startActivity(intent);
            }
        });
