...
public class TruckInTransitTowardsGateAdapter extends RecyclerView.Adapter<TruckInTransitTowardsGateAdapter.MyHolder> {
    ...
    public TruckInTransitTowardsGateAdapter(Context context, List<TruckInCentreModal> arrayList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_truck_in_transit_towards_gate,null);
   ...
   /* private class GetLiveLocation extends AsyncTask<String, Void, Void> {
    ...
    public static class MyHolder extends RecyclerView.ViewHolder
    {
        ...
        TextView centre_code,centre_name,truck_number,driver_name,driver_number,arrival;
