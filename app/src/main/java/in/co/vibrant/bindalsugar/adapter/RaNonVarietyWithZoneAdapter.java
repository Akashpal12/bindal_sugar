...
public class RaNonVarietyWithZoneAdapter extends RecyclerView.Adapter<RaNonVarietyWithZoneAdapter.MyHolder> {
    ...
    public RaNonVarietyWithZoneAdapter(Context context, JSONArray arrayList) {
