...
public class RemadialFinderMapViewMaster extends AppCompatActivity implements OnMapReadyCallback {
    DBHelper dbh;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = RemadialFinderMapViewMaster.this;
        ...
        PLOT_SELECTION=getIntent().getStringExtra("PLOT_SELECTION");
        ...
        try {
            ...
            mapFragment.getMapAsync(RemadialFinderMapViewMaster.this);
    ...
    private class GetMapData extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                SoapObject request1 = new SoapObject(APIUrl.NAMESPACE, APIUrl.method_GETALLREMIDIALPLOTSBYVILLAGE);
                request1.addProperty("Divn", "" + userDetailsModels.get(0).getDivision());
                request1.addProperty("DiseasCode", ""+PLOT_SELECTION);
                ...
                androidHttpTransport.call(APIUrl.SOAP_ACTION_GETALLREMIDIALPLOTSBYVILLAGE, envelope);
                if (envelope.bodyIn instanceof SoapFault) {
                    SoapFault sf = (SoapFault) envelope.bodyIn;
                    message = sf.getMessage();
                } else {
                    SoapObject result = (SoapObject) envelope.bodyIn;
                    message = result.getPropertyAsString("GETALLREMIDIALPLOTSBYVILLAGEResult").toString();
                }
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if (plotFarmerShareArray.length() > 0) {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(RemadialFinderMapViewMaster.this);
