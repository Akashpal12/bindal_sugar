...
public class RaZoneWiseAreaReport extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaZoneWiseAreaReport.this;
        ...
        fromdate_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(RaZoneWiseAreaReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private class getReportDetails extends AsyncTask<String, Integer, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/ZONEWISEAREA";
