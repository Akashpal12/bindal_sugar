...
import in.co.vibrant.bindalsugar.adapter.ListCropGrowthObservationAdapter;
...
public class StaffCropGrowthObservation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= StaffCropGrowthObservation.this;
        ...
        setTitle(getString(R.string.MENU_CROP_GROWTH_OBSERVATION_VIEW));
        toolbar.setTitle (getString(R.string.MENU_CROP_GROWTH_OBSERVATION_VIEW));
                ...
                if(obj.getString("API_STATUS").equalsIgnoreCase("OK"))
                {
                    ...
                    if(jsonArray.length()==0)
                    {
                        ...
                        for(int i=0;i<jsonArray.length();i++)
                        {
                            ...
                            growerFinderModel.setPlotVillageCode(jsonObject.getString("PLOTVILLCD"));
                        ...
                        recyclerView.setLayoutManager(manager);
                        ListCropGrowthObservationAdapter listGrowerFinderAdapter =new ListCropGrowthObservationAdapter(context,dashboardData);
