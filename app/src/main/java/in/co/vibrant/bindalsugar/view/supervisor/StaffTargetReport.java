...
public class StaffTargetReport extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= StaffTargetReport.this;
        setTitle(getString(R.string.MENU_VILLAGE_WISE_TARGET));
        toolbar.setTitle(getString(R.string.MENU_VILLAGE_WISE_TARGET));
