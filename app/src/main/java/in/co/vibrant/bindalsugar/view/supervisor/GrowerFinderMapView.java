...
public class GrowerFinderMapView extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grower_finder_map_view);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        setTitle(getString(R.string.MENU_NEARBY_PLOT));
        context= GrowerFinderMapView.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(GrowerFinderMapView.this);
    ...
    public void opengrowerfinder(View v)
    {
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if(plotFarmerShareArray.length()>0)
        {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(GrowerFinderMapView.this);
                ...
                markerOpt.position(midPoint)
                        ...
                        .snippet("Plot Village :" +jsonObject.getString("PLOTVILLAGE")+" / " + jsonObject.getString("PLOTVILLNAME")+"\n"+
