...
import in.co.vibrant.bindalsugar.view.admin.AdminTargetDetails;


public class AdminMainActivityDataAdapter extends RecyclerView.Adapter<AdminMainActivityDataAdapter.MyHolder> {
    ...
    public AdminMainActivityDataAdapter(Context context, List<StaffTargetModal> arrayList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_admin_main_activity_data,null);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        holder.ivList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(context, AdminTargetDetails.class);
