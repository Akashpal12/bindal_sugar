...
public class AdminAgreeInputAdapter extends RecyclerView.Adapter<AdminAgreeInputAdapter.MyHolder> {
    ...
    public AdminAgreeInputAdapter(Context context, List<AgriInput> arrayList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.agree_input_items, parent,false);
