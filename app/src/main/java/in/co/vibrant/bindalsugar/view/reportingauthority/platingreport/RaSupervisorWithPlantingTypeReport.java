...
import in.co.vibrant.bindalsugar.adapter.RaSupervisorWithPlantingTypeAdapter;
...
public class RaSupervisorWithPlantingTypeReport extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaSupervisorWithPlantingTypeReport.this;
        setTitle("Supervisor Type Wise planting");
        toolbar.setTitle("Supervisor  Type Wise planting");
        ...
        fromdate_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(RaSupervisorWithPlantingTypeReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    class TargetList extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/PLANTTYPEVILLSUPWISETARGETCDO";
        ...
        protected void onPostExecute(String sResponse) {
            ...
            try {
                ...
                RaSupervisorWithPlantingTypeAdapter stockSummeryAdapter =new RaSupervisorWithPlantingTypeAdapter(context,targetFinal);
