...
public class StaffServerFailedPlantingReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Server Failed Planting");
        toolbar.setTitle("Server Failed Planting");
    ...
    {
        plantingModelList=dbh.getPlantingModel("Failed","","","","");
        RecyclerView recyclerView =findViewById(R.id.recycler_view);
        GridLayoutManager manager = new GridLayoutManager(StaffServerFailedPlantingReport.this, 1, GridLayoutManager.VERTICAL, false);
        //recyclerView.setLayoutManager(manager);
        //gridLayoutManager=new GridLayoutManager(MainActivity.this,8,RecyclerView.HORIZONTAL,true);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(manager);
        ListPendingPlantingAdapter listPloughingAdapter =new ListPendingPlantingAdapter(StaffServerFailedPlantingReport.this,plantingModelList);
    ...
    private void AlertPopUp(String msg) {
        android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.Builder(
                StaffServerFailedPlantingReport.this);
