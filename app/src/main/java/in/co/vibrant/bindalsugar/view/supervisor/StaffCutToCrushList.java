...
import in.co.vibrant.bindalsugar.adapter.ListCutToCrushReportAdapter;
...
public class StaffCutToCrushList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = StaffCutToCrushList.this;
    ...
    private class GetDataList extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                //request1.addProperty("lat", "27.8152827");
                request1.addProperty("lng", params[1]);
               // request1.addProperty("lng", "81.099359");
            ...
            try {
                ...
                if (obj.getString("API_STATUS").equalsIgnoreCase("OK")) {
                    ...
                    if (jsonArray.length() == 0) {
                        ...
                        recyclerView.setLayoutManager(manager);
                        ListCutToCrushReportAdapter listGrowerFinderAdapter = new ListCutToCrushReportAdapter(context, dashboardData);
