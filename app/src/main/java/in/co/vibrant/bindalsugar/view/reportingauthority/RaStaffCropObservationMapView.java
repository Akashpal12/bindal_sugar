...
import in.co.vibrant.bindalsugar.view.supervisor.StaffCropObservation;

public class RaStaffCropObservationMapView extends AppCompatActivity implements OnMapReadyCallback {
    DBHelper dbh;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaStaffCropObservationMapView.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(RaStaffCropObservationMapView.this);
        ...
        try {
            ...
            if (plotFarmerShareModelList.size() > 0) {
                for (int i = 0; i < plotFarmerShareModelList.size(); i++) {
                    ...
                    CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(RaStaffCropObservationMapView.this);
    ...
    private void AlertPopUp(String msg) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                RaStaffCropObservationMapView.this);
