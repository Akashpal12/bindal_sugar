...
public class PocPlotFinderMapView extends AppCompatActivity implements OnMapReadyCallback {
    DBHelper dbh;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = PocPlotFinderMapView.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(PocPlotFinderMapView.this);
    ...
    private class GetMapData extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                SoapObject request1 = new SoapObject(APIUrl.NAMESPACE, APIUrl.method_GETPOCNEARESTPLOTSBYLATLNG1);
                ...
                androidHttpTransport.call(APIUrl.SOAP_ACTION_GETPOCNEARESTPLOTSBYLATLNG1, envelope);
                if (envelope.bodyIn instanceof SoapFault) {
                    SoapFault sf = (SoapFault) envelope.bodyIn;
                    message = sf.getMessage();
                } else {
                    SoapObject result = (SoapObject) envelope.bodyIn;
                    message = result.getPropertyAsString("GETPOCNEARESTPLOTSBYLATLNG1Result").toString();
                }
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if (plotFarmerShareArray.length() > 0) {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(PocPlotFinderMapView.this);
