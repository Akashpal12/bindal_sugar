...
public class ListGetVillageWiseCaneTypeSummeryAdapter extends RecyclerView.Adapter<ListGetVillageWiseCaneTypeSummeryAdapter.MyHolder> {
    ...
    public ListGetVillageWiseCaneTypeSummeryAdapter(Context context, JSONArray jsonArray) {
