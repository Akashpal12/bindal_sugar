...
import in.co.vibrant.bindalsugar.view.grower.GrowerActivityForm;


public class PotatoTodayActivityAdapter extends RecyclerView.Adapter<PotatoTodayActivityAdapter.MyHolder> {
    ...
    public PotatoTodayActivityAdapter(Context context, List<PotatoTodayActivityModal> arrayList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_potato_today_activity,null);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        holder.ivAction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(context, GrowerActivityForm.class);
        ...
        mMapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(final GoogleMap googleMap) {
                ...
                /*Polygon polygon1 = googleMap.addPolygon(new PolygonOptions()
                        .clickable(true)
                        .add(
                                new LatLng(26.870510, 81.015314),
                                new LatLng(26.870268, 81.015238),
                                new LatLng(26.870235, 81.015395),
                                new LatLng(26.870467, 81.015460),
                                new LatLng(26.870510, 81.015314)
                        ));*/
