...
public class RaStaffVerticalCheckMapView extends AppCompatActivity implements OnMapReadyCallback {
    DBHelper dbh;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaStaffVerticalCheckMapView.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(RaStaffVerticalCheckMapView.this);
        ...
        try {
            ...
            if (plotFarmerShareModelList.size() > 0) {
                for (int i = 0; i < plotFarmerShareModelList.size(); i++) {
                    ...
                    CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(RaStaffVerticalCheckMapView.this);
    ...
    private void AlertPopUp(String msg) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                RaStaffVerticalCheckMapView.this);
