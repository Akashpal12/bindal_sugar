...
import in.co.vibrant.bindalsugar.view.supervisor.survey.AddGrowerShareCane;


public class PendingShareListAdapter extends RecyclerView.Adapter<PendingShareListAdapter.MyHolder> {

    private Context context;
    List<FarmerShareModel> arrayList;


    public PendingShareListAdapter(Context context, List<FarmerShareModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        if(position>0)
        {
            List<PlotSurveyModel> plotSurveyModelList1=dbh.getPlotSurveyModelById(arrayList.get(position).getSurveyId());
            ...
            holder.survey_id.setText(plotSurveyModelList1.get(0).getPlotSrNo());
        ...
        holder.edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context, AddGrowerShareCane.class);
                intent.putExtra("survey_id",""+arrayList.get(position).getSurveyId());
