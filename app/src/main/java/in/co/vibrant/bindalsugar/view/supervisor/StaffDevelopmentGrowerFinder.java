...
public class StaffDevelopmentGrowerFinder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= StaffDevelopmentGrowerFinder.this;
            ...
            try{
                ...
                if(jsonArray.length()==0)
                {
                    ...
                    for(int i=0;i<jsonArray.length();i++)
                    {
                        ...
                        growerFinderModel.setVarietyGroupCode(jsonObject.getString("VrCode"));
