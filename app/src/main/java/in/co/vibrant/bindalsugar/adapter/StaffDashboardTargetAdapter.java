...
public class StaffDashboardTargetAdapter extends RecyclerView.Adapter<StaffDashboardTargetAdapter.MyHolder> {
    ...
    public StaffDashboardTargetAdapter(Context context, List<StaffTargetModal> arrayList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_staff_tracker_dashboard,null);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        holder.textper.setText(decimalFormat.format(progress)+"% "+context.getString(R.string.LBL_COL_AREA));
        holder.progressBar.setMax(100);
        holder.progressBar.setProgress((int) progress);

        holder.textper_grower.setText(decimalFormat.format(progressGrower)+"% "+context.getString(R.string.LBL_COL_GROWER));
        ...
        if(delay<1)
        {
            holder.tv_village.setText(context.getString(R.string.LBL_VILLAGE)+arrayList.get(position).getDelay());
            holder.rlLayoutHeader.setBackgroundColor(Color.parseColor("#355E37"));
            holder.tv_name.setTextColor(Color.parseColor("#FFFFFF"));
            holder.tv_village.setTextColor(Color.parseColor("#FFFFFF"));
        }
    ...
    {
        TextView tvCount,tv_name,tv_village,start_date,end_date,target_area,target_grower,complete_area,complete_grower,balance_area
                ,balance_grower,area_exp,grower_exp,area_delay,grower_delay,textper,textper_grower;
