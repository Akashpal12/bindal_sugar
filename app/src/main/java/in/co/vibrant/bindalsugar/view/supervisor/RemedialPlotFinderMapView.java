...
public class RemedialPlotFinderMapView extends AppCompatActivity implements OnMapReadyCallback {
    DBHelper dbh;
    SQLiteDatabase db;
    ...
    String message,PLOT_TYPE_SELECTION;
    JSONArray plotFarmerShareArray;
    private String currentPlotColorCode;
    private String currentPlotDisease;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = RemedialPlotFinderMapView.this;
        ...
        GET_DISEASE=  getIntent().getStringExtra("GET_DISEASE");
        try {
            //lat=29.3934217;
            //lng=78.16364;
            ...
            mapFragment.getMapAsync(RemedialPlotFinderMapView.this);
    ...
    private class GetMapData extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                SoapObject request1 = new SoapObject(APIUrl.NAMESPACE, APIUrl.method_GETREMIDIALNEARESTPLOTSBYLATLNGDISEAS);
                request1.addProperty("lat", "" + lat);
                request1.addProperty("lng", "" + lng);
                request1.addProperty("Divn", "" + userDetailsModels.get(0).getDivision());
                request1.addProperty("DiseasCode", "" + GET_DISEASE);
                ...
                androidHttpTransport.call(APIUrl.SOAP_ACTION_GETREMIDIALNEARESTPLOTSBYLATLNGDISEAS, envelope);
                if (envelope.bodyIn instanceof SoapFault) {
                    SoapFault sf = (SoapFault) envelope.bodyIn;
                    message = sf.getMessage();
                } else {
                    SoapObject result = (SoapObject) envelope.bodyIn;
                    message = result.getPropertyAsString("GETREMIDIALNEARESTPLOTSBYLATLNGDISEASResult").toString();
                }
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if (plotFarmerShareArray.length() > 0) {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(RemedialPlotFinderMapView.this);
