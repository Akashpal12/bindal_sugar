...
public class SupVillageWithPlantingTypeAdapter extends RecyclerView.Adapter<SupVillageWithPlantingTypeAdapter.MyHolder> {
    ...
    public SupVillageWithPlantingTypeAdapter(Context context, List<ReportMultiple> arrayList) {
