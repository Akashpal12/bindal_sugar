...
import in.co.vibrant.bindalsugar.adapter.ServerAllShareListAdapter;
...
public class StaffAllSurveyDataListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.MENU_ALL_SURVEY_DATA));
        ...
        List<FarmerShareModel> farmerShareModelList=dbh.getFarmerShareModel("");
        ...
        GridLayoutManager manager = new GridLayoutManager(StaffAllSurveyDataListActivity.this, 1, GridLayoutManager.VERTICAL, false);
        //recyclerView.setLayoutManager(manager);
        //gridLayoutManager=new GridLayoutManager(MainActivity.this,8,RecyclerView.HORIZONTAL,true);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(manager);
        ServerAllShareListAdapter stockSummeryAdapter =new ServerAllShareListAdapter(StaffAllSurveyDataListActivity.this,farmerShareModelList1);
