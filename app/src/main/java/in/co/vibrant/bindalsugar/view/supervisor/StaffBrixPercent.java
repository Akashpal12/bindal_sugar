...
import in.co.vibrant.bindalsugar.adapter.ListBrixPercentAdapter;
...
public class StaffBrixPercent extends AppCompatActivity {
            ...
            try{
                ...
                if(obj.getString("API_STATUS").equalsIgnoreCase("OK"))
                {
                    ...
                    if(jsonArray.length()==0)
                    {
                        ...
                        recyclerView.setLayoutManager(manager);
                        ListBrixPercentAdapter listGrowerFinderAdapter =new ListBrixPercentAdapter(context,dashboardData);
