...
public class GrowerWeightmentActivityAdapter extends RecyclerView.Adapter<GrowerWeightmentActivityAdapter.MyHolder> {

    private Context context;
    List<GrowerWeightmentActivityModel> arrayList;


    public GrowerWeightmentActivityAdapter(Context context, List<GrowerWeightmentActivityModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        holder.txt7.setText(arrayList.get(position).getIsFtn());
        holder.txt4.setText(arrayList.get(position).getIsCol());
        holder.txt3.setText(arrayList.get(position).getMode());
        holder.txt5.setText(arrayList.get(position).getIssueDate());
        holder.txt6.setText(arrayList.get(position).getDispatchedDate());
        holder.txt2.setText(arrayList.get(position).getMillPurNumber());
        holder.txt8.setText(arrayList.get(position).getPayDate());
        holder.txt9.setText(arrayList.get(position).getVariety());
        holder.txt10.setText(arrayList.get(position).getNetWeight());
        holder.txt11.setText(arrayList.get(position).getAmount());
        holder.txt12.setText(arrayList.get(position).getStatus());
