...
public class RemedialJsonDoneModel {

    private String REMICODE;
    private String REMIDIALNAME;
    ...
    public String getREMIDIALNAME() {
        return REMIDIALNAME;
    }

    public void setREMIDIALNAME(String REMIDIALNAME) {
        this.REMIDIALNAME = REMIDIALNAME;
    }
