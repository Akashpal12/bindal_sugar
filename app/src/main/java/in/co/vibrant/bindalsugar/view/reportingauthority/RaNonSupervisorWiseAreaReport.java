...
import in.co.vibrant.bindalsugar.adapter.RaNonSupervisorAreaReportListAdapter;
...
public class RaNonSupervisorWiseAreaReport extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= RaNonSupervisorWiseAreaReport.this;
        ...
        fromdate_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(RaNonSupervisorWiseAreaReport.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
    ...
    private class getReportDetails extends AsyncTask<String, Integer, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/SupervoiserWiseSummary1";
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                else
                {
                    ...
                    double onManual=0.0,onGps=0.0,toManual=0.0,toGps=0.0;
                ...
                recyclerView.setLayoutManager(manager);
                RaNonSupervisorAreaReportListAdapter stockSummeryAdapter =new RaNonSupervisorAreaReportListAdapter(context,staffTargetModelList);
