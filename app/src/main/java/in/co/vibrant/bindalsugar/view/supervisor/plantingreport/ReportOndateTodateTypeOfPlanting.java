...
public class ReportOndateTodateTypeOfPlanting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= ReportOndateTodateTypeOfPlanting.this;
        dbh=new DBHelper(context);
        setContentView(R.layout.report_table_with_filter);
        try {
            Toolbar toolbar = findViewById(R.id.toolbar);
            setSupportActionBar(toolbar);
            setTitle("Ondate and Todate Type of Planting");
            toolbar.setTitle("Ondate and Todate Type of Planting");
    ...
    public void openFiler(View v)
    {
        ...
        ArrayAdapter<String> adaptertypeOfPlanting = new ArrayAdapter<String>(ReportOndateTodateTypeOfPlanting.this,
    ...
    private class GenerateTables extends AsyncTask<Void, Integer, Void> {
        ...
        private final SoftReference<ReportOndateTodateTypeOfPlanting> activityReference;
        ...
        GenerateTables(Context context, String data) {
            ...
            activityReference = new SoftReference<>(ReportOndateTodateTypeOfPlanting.this);
        }
        ...
        protected void onPreExecute() {
            ...
            ReportOndateTodateTypeOfPlanting activity = activityReference.get();
    ...
    private void createTable(Context mContext,JSONArray jsonArray){
        try{
            ...
            for (int i = 0; i <jsonArray.length(); i++) {
                ...
                Typeface typeface2 = ResourcesCompat.getFont(this, R.font.roboto_black);
                ...
                Typeface typefaceTRCODE = ResourcesCompat.getFont(this, R.font.roboto_black);
                textView1.setTypeface(typefaceTRCODE);
                ...
                textView3.setText(jsonObject.getString("ONDATEACHIEV"));
                Typeface typefaceONDATEACHIEV = ResourcesCompat.getFont(this, R.font.roboto_black);
                textView3.setTypeface(typefaceONDATEACHIEV);
                ...
                textView4.setText(jsonObject.getString("TODATEACHIEV"));
                Typeface typefaceTODATEACHIEV = ResourcesCompat.getFont(this, R.font.roboto_black);
                textView4.setTypeface(typefaceTODATEACHIEV);
                ...
                ondate +=jsonObject.getDouble("ONDATEACHIEV");
                todate +=jsonObject.getDouble("TODATEACHIEV");
            ...
            Typeface typefacePlanting = ResourcesCompat.getFont(this, R.font.roboto_black);
            textView1.setTypeface(typefacePlanting);
            //textView1.setBackgroundResource(R.drawable.list_border);
            textView1.setPadding(5 ,5,5,5);
            ...
            Typeface typefaceArea = ResourcesCompat.getFont(this, R.font.roboto_black);
            textView5.setTypeface(typefaceArea);
            ...
            textView11.setText("");
            Typeface typeface21 = ResourcesCompat.getFont(this, R.font.roboto_black);
            textView11.setTypeface(typeface21);
            ...
            textView12.setText("");
            Typeface typeface212 = ResourcesCompat.getFont(this, R.font.roboto_black);
            textView12.setTypeface(typeface212);
            ...
            textView13.setText("Ondate");
            Typeface typeface22 = ResourcesCompat.getFont(this, R.font.roboto_black);
            textView13.setTypeface(typeface22);
            ...
            textView14.setText("Todate");
            Typeface typeface112 = ResourcesCompat.getFont(this, R.font.roboto_black);
            ...
            Typeface typeface2Sr = ResourcesCompat.getFont(this, R.font.roboto_black);
            textView.setTypeface(typeface2Sr);
            //textView.setBackgroundResource(R.drawable.list_border);
            textView.setPadding(5 ,5,5,5);
            textView.setTextSize(textSize);
            textView.setTextColor(getResources().getColor(R.color.black));
            ...
            textView1Sr.setText("");
            Typeface typeface2525 = ResourcesCompat.getFont(this, R.font.roboto_black);
            textView1Sr.setTypeface(typeface2525);
    ...
    private class GetData extends AsyncTask<String, Integer, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/PLANTTYPESUPWISETARGETONTODATE";
