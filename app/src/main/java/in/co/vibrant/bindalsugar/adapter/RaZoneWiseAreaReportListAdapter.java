...
public class RaZoneWiseAreaReportListAdapter extends RecyclerView.Adapter<RaZoneWiseAreaReportListAdapter.MyHolder> {
    ...
    public RaZoneWiseAreaReportListAdapter(Context context, List <StaffTargetModel> arrayList) {
