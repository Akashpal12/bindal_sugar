...
public class SupervisorAreaDateWiseReportListAdapter extends RecyclerView.Adapter<SupervisorAreaDateWiseReportListAdapter.MyHolder> {
    ...
    public SupervisorAreaDateWiseReportListAdapter(Context context, List <StaffTargetModel> arrayList) {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_report_zone_wise_area_date_list,null);
    ...
    public void onBindViewHolder(MyHolder holder, final int position) {
        try {
            ...
            holder.txt2.setText(arrayList.get(position).getOnManualArea());
            holder.txt3.setText(arrayList.get(position).getToManualArea());
            holder.txt4.setText(arrayList.get(position).getOnGpsArea());
            holder.txt5.setText(arrayList.get(position).getToGpsArea());
