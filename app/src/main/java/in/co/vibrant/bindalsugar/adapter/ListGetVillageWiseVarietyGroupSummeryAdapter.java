...
public class ListGetVillageWiseVarietyGroupSummeryAdapter extends RecyclerView.Adapter<ListGetVillageWiseVarietyGroupSummeryAdapter.MyHolder> {
    ...
    public ListGetVillageWiseVarietyGroupSummeryAdapter(Context context, JSONArray jsonArray) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        try{
            ...
            thl5.setTypeface(typefaced);
            thl6.setText("Area");
            thl6.setTypeface(typefaced);
            thl7.setText("No Of Plot");
            thl7.setTypeface(typefaced);
            thl8.setText("Area");
            thl8.setTypeface(typefaced);
            thl9.setText("No Of Plot");
            thl9.setTypeface(typefaced);
            thl10.setText("Area");
            thl10.setTypeface(typefaced);
