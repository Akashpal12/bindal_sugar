...
public class RemedialJsonDoneDataAdapter extends RecyclerView.Adapter<RemedialJsonDoneDataAdapter.MYholder> {
    private Context context;
    List<RemedialJsonDoneModel> arrayList;
    AlertDialog AlertdialogBox;


    public RemedialJsonDoneDataAdapter(Context context, List<RemedialJsonDoneModel> arrayList) {
