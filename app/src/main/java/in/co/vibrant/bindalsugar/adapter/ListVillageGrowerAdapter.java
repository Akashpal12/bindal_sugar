...
public class ListVillageGrowerAdapter extends RecyclerView.Adapter<ListVillageGrowerAdapter.MyHolder> {

    private Context context;
    List <GrowerVillageMeetingModal> arrayList;


    public ListVillageGrowerAdapter(Context context, List <GrowerVillageMeetingModal> arrayList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout= LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item_vill_grow_input_model,null);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        try {
            if (position == 0) {
                holder.txt_1.setText("Village");
                holder.txt_2.setText("Grower");
                holder.txt_3.setText("Father");
                ...
                holder.txt_1.setText(""+arrayList.get(pos).getVillCode()+" / "+arrayList.get(pos).getVillName());
                holder.txt_2.setText(""+arrayList.get(pos).getGrowCode()+" / "+arrayList.get(pos).getGrowerName());
                holder.txt_3.setText(""+arrayList.get(pos).getFather());
