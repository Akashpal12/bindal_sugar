...
public class GrowerModel {
    ...
    protected String growerVillge;
    protected String villegename;
    ...
    public boolean equals(Object o) {
        ...
        GrowerModel that = (GrowerModel) o;
    ...
    public String getGrowerVillge() {
        return growerVillge;
    }

    public void setGrowerVillge(String growerVillge) {
        this.growerVillge = growerVillge;
    }
