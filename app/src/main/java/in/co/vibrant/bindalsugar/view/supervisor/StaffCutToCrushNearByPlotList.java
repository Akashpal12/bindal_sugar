...
public class StaffCutToCrushNearByPlotList extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = StaffCutToCrushNearByPlotList.this;
        ...
        try {
            ...
            mapFragment.getMapAsync(StaffCutToCrushNearByPlotList.this);
    ...
    public void openPlotActivity(View v) {
        Intent intent = new Intent(context, StaffCutToCrushList.class);
    ...
    public void drawPlot(JSONArray plotFarmerShareArray) throws JSONException {
        if (plotFarmerShareArray.length() > 0) {
            for (int i = 0; i < plotFarmerShareArray.length(); i++) {
                ...
                CustomInfoWindowAdapter adapter = new CustomInfoWindowAdapter(StaffCutToCrushNearByPlotList.this);
    ...
    private class GetMapData extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                //request1.addProperty("lat", "27.8929094");
                //request1.addProperty("lng", "81.1356159");
