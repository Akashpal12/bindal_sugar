...
import in.co.vibrant.bindalsugar.adapter.StaffSeedReservationAdapter;
...
public class ReportSupervisorSeedReservationDetails extends AppCompatActivity  {
    ...
    List<SeedReservationModel> seedReservationModelList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context= ReportSupervisorSeedReservationDetails.this;
        ...
        try{
            ...
            fromdate_select.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    DatePickerDialog dpd = new DatePickerDialog(ReportSupervisorSeedReservationDetails.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
            ...
            btn_ok.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    try {
                        if(village.getSelectedItemPosition()==0 && grower.getSelectedItemPosition()==0){
                            new GetData().execute("0", "0",fromdate_select.getText().toString(),todate_selects.getText().toString());
                        } else {
                            new GetData().execute(villageSurveyModelList.get(village.getSelectedItemPosition()).getVillageCode(), varietyList.get(grower.getSelectedItemPosition()).getCode(),fromdate_select.getText().toString(),todate_selects.getText().toString());
                        }
                    }
                    catch(Exception e)
                    {
    ...
    class GetData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                String url= APIUrl.BASE_URL_CANE_DEVELOPMENT +"/GETSUPERVOISERSEEDREGDETAILS";
        ...
        protected void onPostExecute(String sResponse) {
            ...
            try {
                if (dialog.isShowing())
                    dialog.dismiss();
                seedReservationModelList=new ArrayList<>();
                JSONArray jsonArray = new JSONArray(Content);

                SeedReservationModel header=new SeedReservationModel();
                ...
                header.setTransportation("TRANSPORTER");
                header.setQuantity("QTY");
                header.setRate("RATE");
                header.setColor("#000000");
                header.setTextColor("#FFFFFF");
                seedReservationModelList.add(header);

                for(int i=0;i<jsonArray.length();i++)
                {
                    JSONObject jsonObject=jsonArray.getJSONObject(i);
                    SeedReservationModel seedReservationModel=new SeedReservationModel();
                    seedReservationModel.setVillage(jsonObject.getString("VCODE"));
                    seedReservationModel.setVillageName(jsonObject.getString("VNAME"));
                    seedReservationModel.setGrower(jsonObject.getString("GCODE"));
                    seedReservationModel.setGrowerName(jsonObject.getString("GNAME"));
                    seedReservationModel.setGrowerFather(jsonObject.getString("GFATHER"));
                    ...
                    seedReservationModel.setTransportation(jsonObject.getString("TRANSPORTER"));
                    seedReservationModel.setQuantity(jsonObject.getString("QTY"));
                    seedReservationModel.setRate(jsonObject.getString("RATE"));
                    if(i%2==0)
                    {
                    ...
                    seedReservationModelList.add(seedReservationModel);
                }
                ...
                StaffSeedReservationAdapter stockSummeryAdapter =new StaffSeedReservationAdapter(context,seedReservationModelList);
