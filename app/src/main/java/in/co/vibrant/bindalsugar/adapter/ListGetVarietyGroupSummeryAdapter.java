...
public class ListGetVarietyGroupSummeryAdapter extends RecyclerView.Adapter<ListGetVarietyGroupSummeryAdapter.MyHolder> {

    private Context context;
    JSONArray jsonArray;


    public ListGetVarietyGroupSummeryAdapter(Context context, JSONArray jsonArray) {
    ...
    public static class MyHolder extends RecyclerView.ViewHolder
    {
        ...
        TextView tv_sup_name,tv_sup_area,tv_sup_plot,tv_sup_grower;
